...
function deleteproducts(id, productname) {
  document.getElementById("deleteproductmodal").href =
    "/admin/deleteproduct?id=" + id;
  document.getElementById("modal-body-id").innerHTML =
    "Are you sure do you want to delete " + productname;
}

function blockuser(phonenumber, name) {
  document.getElementById("updateUser").href =
    "/admin/blockuser?phonenumber=" + phonenumber;
  document.getElementById("modal-body-id").innerHTML =
    "Are you sure do you want to block " + name;
}

function unblockuser(phonenumber, name) {
  document.getElementById("updateUser").href =
    "/admin/unblockuser?phonenumber=" + phonenumber;
  document.getElementById("modal-body-id").innerHTML =
    "Are you sure do you want to unblock " + name;
}
...
$("#editproduct").validate({
  ...
  submitHandler: function onsubmitForm(form) {
    swal({
      title: "Are you sure?",
...
function BannerOneFileValidation() {
  var fileInput = document.getElementById("banner1image");
  ...
  if (!allowedExtensions.exec(filePath)) {
    ...
    if (fileInput.files && fileInput.files[0]) {
      ...
      reader.onload = function (e) {
        document.getElementById("imagePreviewBannerOne").innerHTML =
...
function BannerTwoFileValidation() {
  var fileInput = document.getElementById("banner2image");
  ...
  if (!allowedExtensions.exec(filePath)) {
    ...
    if (fileInput.files && fileInput.files[0]) {
      var reader = new FileReader();
      reader.onload = function (e) {
        document.getElementById("imagePreviewBannerTwo").innerHTML =
          '<img style="width:120px;height:120px" src="' +
          e.target.result +
          '"/>';
      };
...
function productBannerOneFileValidation() {
  var fileInput = document.getElementById("productbanner1image");
  ...
  if (!allowedExtensions.exec(filePath)) {
    ...
    if (fileInput.files && fileInput.files[0]) {
      var reader = new FileReader();
      reader.onload = function (e) {
        document.getElementById("imagePreviewproductBannerOne").innerHTML =
          '<img style="width:120px;height:120px" src="' +
          e.target.result +
          '"/>';
      };
...
function productBannerTwoFileValidation() {
  var fileInput = document.getElementById("productbanner2image");
  ...
  if (!allowedExtensions.exec(filePath)) {
    ...
    if (fileInput.files && fileInput.files[0]) {
      var reader = new FileReader();
      reader.onload = function (e) {
        document.getElementById("imagePreviewproductBannerTwo").innerHTML =
          '<img style="width:120px;height:120px" src="' +
          e.target.result +
          '"/>';
      };
...
function categoryOfferEdit(id) {
  $.ajax({
    ...
    success: (response) => {
      if (response) {
        document.getElementById("discountedit").value =
...
function couponOfferEdit(id) {
  $.ajax({
    ...
    success: (response) => {
      if (response) {
        document.getElementById("coupondiscountedit").value =
          response.coupenpercentage;
        document.getElementById("coupondisabledoption").innerHTML =
          response.coupencode;
        document.getElementById("couponhiddencode").value = response.coupencode;
        document.getElementById("couponstartdateedit").value =
          response.coupenstartdate;
        document.getElementById("couponenddateedit").value =
          response.coupenenddate;
      } else {
      }
    },
  });
...
function deletecategoryoffer(category, offerpercentage) {
  swal("Are you sure you want to remove " + category + " offer ?", {
    ...
    if (willdelete) {
      $.ajax({
        url:
          "/admin/deletecategoryoffer?category=" +
          category +
          "&percentage=" +
          offerpercentage,
...
function productOfferEdit(id) {
  $.ajax({
    ...
    success: (response) => {
      ...
      document.getElementById("startdateeditproduct").value =
        response.profferstartdate;
      document.getElementById("enddateeditproduct").value =
        response.profferenddate;
    },
  });
}
