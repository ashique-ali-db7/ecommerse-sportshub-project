...
module.exports = {
  addProduct: (data) => {
    ...
    return new Promise(async (resolve, reject) => {
      ...
      productExist = await db
        .get()
        .collection(collections.PRODUCTS_DETAILS_COLLECTION)
      ...
      if (productExist) {
        ...
        await db
          ...
          .insertOne({
            ...
            landingprice: data.price,
            price: data.price,
            description: data.description,
            instock: [
              { id: smallid, size: "s", quantity: data.smallquantity },
              { id: mediumid, size: "m", quantity: data.mediumquantity },
              { id: largeid, size: "l", quantity: data.largequantity },
            ],
          })
          .then((data) => {
        ...
        .updateOne(
          { productid: productid.productid },
          {
            $set: {
              ...
              description: data.description,
              instock: [
                { size: "s", quantity: data.smallquantity },
                { size: "m", quantity: data.mediumquantity },
                { size: "l", quantity: data.largequantity },
              ],
            },
          }
        )
  ...
  instock: (id) => {
    return new Promise(async (resolve, reject) => {
      let stockArray = await db
        .get()
        .collection(collections.PRODUCTS_DETAILS_COLLECTION)
        .findOne({ _id: objectId(id) }, { instock: 1 });
    });
  },
  ...
  addToCart: (proId, size, userId, subtotal) => {
    ...
    return new Promise(async (resolve, reject) => {
      ...
      let userCart = await db
        .get()
        .collection(collections.CART_DETAILS_COLLECTION)
        .findOne({ user: objectId(userId) });

      if (userCart) {
        let userProductExist = await db
          .get()
          .collection(collections.CART_DETAILS_COLLECTION)
          .aggregate([
          ...
          .updateOne(
            ...
            },
            {
              $inc: {
                ...
                "products.$.subtotal": data.price * -1,
              },
            }
          )
          .then(() => {
    ...
    return new Promise(async (resolve, reject) => {
      await db
        ...
        .updateOne(
          ...
          {
            $pull: {
              products: { item: objectId(data.proId), size: data.size },
            },
          }
        )
        .then((response) => {
  ...
  allCategoryProducts: (categoryname) => {
    return new Promise(async (resolve, reject) => {
      let allSingleCategoryProduct = await db
        .get()
        .collection(collections.PRODUCTS_DETAILS_COLLECTION)
  ...
  addCategoryOffer: (data) => {
    ...
    return new Promise(async (resolve, reject) => {
      ...
      let exist = await db
        .get()
        .collection(collections.CATEGORYOFFER_DETAILS_COLLECTION)
  ...
  getAllCategoryOffers: () => {
    return new Promise(async (resolve, reject) => {
      let allCategoryOffers = await db
        .get()
        .collection(collections.CATEGORYOFFER_DETAILS_COLLECTION)
        .find()
        .toArray();
  ...
  addProductOffer: (data) => {
    return new Promise(async (resolve, reject) => {
      ...
      let response = {};
      let productAlreadyHaveOffer = await db
        .get()
        .collection(collections.PRODUCTS_DETAILS_COLLECTION)
        .findOne({ productname: data.productname, offer: { $exists: true } });
      ...
      if (productAlreadyHaveOffer) {
        ...
        db.get()
          .collection(collections.PRODUCTOFFER_DETAILS_COLLECTION)
          .insertOne(data);
  ...
  editCategoryOffer: (data) => {
    ...
    data.startDateIso = startDateIso;
    return new Promise(async (resolve, reject) => {
      let dataOfProductOffer = await db
        .get()
        .collection(collections.CATEGORYOFFER_DETAILS_COLLECTION)
        .findOne({ category: data.category });
      db.get()
        ...
        .updateOne(
          { category: data.category },
          {
            $set: {
              ...
              caofferstartdate: data.caofferstartdate,
              caofferenddate: data.caofferenddate,
  ...
  editCouponOffer: (data) => {
    return new Promise(async (resolve, reject) => {
      ...
      db.get()
        .collection(collections.COUPEN_DETAILS_COLLECTION)
        .updateOne(
          { coupencode: data.coupen },
          {
            $set: {
              coupenpercentage: data.coupondiscountpercentage,
              coupenstartdate: data.couponfferstartdate,
              coupenenddate: data.couponofferenddate,
              coupenIsoStartDate: coupenIsoStartDate,
              coupenIsoEndDate: coupenIsoEndDate,
              available: false,
            },
          }
        );
  ...
  deleteCategoryOffers: (data) => {
    return new Promise(async (resolve, reject) => {
      ...
      let allProducts = await db
        .get()
        .collection(collections.PRODUCTS_DETAILS_COLLECTION)
        .find({ category: data.category, offerpercentage: data.percentage })
        .toArray();
      ...
      await allProducts.map(async (product) => {
        ...
        db.get()
          ...
          .updateOne(
            ...
            { $unset: { offer: "", offerpercentage: "" } }
          );
        db.get()
          .collection(collections.PRODUCTS_DETAILS_COLLECTION)
          .updateOne(
            { _id: objectId(product._id) },
            { $set: { price: landingprice } }
          );
    ...
    return new Promise(async (resolve, reject) => {
      db.get()
        ...
        .updateOne(
          ...
          {
            $set: {
              discount: data.discountpercentageproduct,
              profferstartdate: data.profferstartdate,
              profferenddate: data.profferenddate,
              proendDateIso: data.proendDateIso,
              prostartDateIso: data.prostartDateIso,
            },
          }
        );
  ...
  deleteProductOffers: (data) => {
    return new Promise(async (resolve, reject) => {
      db.get()
        .collection(collections.PRODUCTOFFER_DETAILS_COLLECTION)
        .deleteOne({ productname: data.productname });
      ...
      db.get()
        ...
        .updateOne(
          { productname: data.productname },
          { $set: { price: product.landingprice } }
        );
      db.get()
        .collection(collections.PRODUCTS_DETAILS_COLLECTION)
        .updateOne(
  ...
  deleteExpiredproductoffers: (date) => {
    ...
    return new Promise(async (resolve, reject) => {
      let existingProductOffer = await db
        .get()
        .collection(collections.PRODUCTOFFER_DETAILS_COLLECTION)
        .find({ proendDateIso: { $lte: proendDateIso } })
        .toArray();
      ...
      if (existingProductOffer.length > 0) {
        await existingProductOffer.map(async (onedata) => {
          db.get()
            .collection(collections.PRODUCTOFFER_DETAILS_COLLECTION)
            .deleteOne({ productname: onedata.productname });
          let product = await db
            .get()
            .collection(collections.PRODUCTS_DETAILS_COLLECTION)
            .findOne({ productname: onedata.productname });
  ...
  deleteCategoryoffers: (date) => {
    ...
    return new Promise(async (resolve, reject) => {
      let existingCategoryOffer = await db
        .get()
        .collection(collections.CATEGORYOFFER_DETAILS_COLLECTION)
        .findOne({ endDateIso: { $lte: caendDateIso } });
      if (existingCategoryOffer) {
        db.get()
          .collection(collections.CATEGORYOFFER_DETAILS_COLLECTION)
          .deleteOne({ category: existingCategoryOffer.category });

        let allProducts = await db
          .get()
          .collection(collections.PRODUCTS_DETAILS_COLLECTION)
          .find({
            category: existingCategoryOffer.category,
            offerpercentage: existingCategoryOffer.discountpercentage,
          })
          .toArray();
  ...
  deliveredOrders: () => {
    return new Promise(async (resolve, reject) => {
      let result = await db
        .get()
        .collection(collections.ORDER_DETAILS_COLLECTION)
        .aggregate([
          {
            $unwind: "$products",
          },
  ...
  totalCategorysales: () => {
    return new Promise(async (resolve, reject) => {
      let categorywisesales = await db
        .get()
        .collection(collections.ORDER_DETAILS_COLLECTION)
        .aggregate([
          {
          ...
          },
          {
            $project: {
              item: 1,
              productdetail: { $arrayElemAt: ["$productdetail.category", 0] },
            },
          },
          {
            $group: {
      ...
      var newArraycategorywisesales = categorywisesales.filter(
        (item) => item._id !== null
      );
  ...
  addToBuyProduct: (proId, size, userId, subtotal) => {
    ...
    return new Promise(async (resolve, reject) => {
      ...
      let userBuynow = await db
        .get()
        .collection(collections.BUYNOW_DETAILS_COLLECTION)
        .findOne({ user: objectId(userId) });
      ...
      if (userBuynow) {
        ...
        db.get()
          .collection(collections.BUYNOW_DETAILS_COLLECTION)
          .updateOne({ user: objectId(userId) }, { $pop: { products: -1 } });
  ...
  addToWishList: (proId, userId) => {
    return new Promise(async (resolve, reject) => {
      ...
      let userwishlistexist = await db
        .get()
        .collection(collections.WISHLIST_DETAILS_COLLECTION)
        .findOne({ user: objectId(userId) });
      ...
      if (userwishlistexist) {
        let userProductExist = await db
          ...
          .findOne({
            user: objectId(userId),
            products: { $elemMatch: { $eq: objectId(proId) } },
          });
  ...
  deleteExpiredCategoryoffers: (date) => {
    ...
    return new Promise(async (resolve, reject) => {
      let data = await db
        .get()
        .collection(collections.CATEGORYOFFER_DETAILS_COLLECTION)
        .find({ endDateIso: { $lte: endDateIso } })
        .toArray();
      ...
      if (data.length > 0) {
        await data.map(async (onedata) => {
          ...
          db.get()
            .collection(collections.CATEGORYOFFER_DETAILS_COLLECTION)
            .deleteOne({ category: onedata.category });
          await allProducts.map(async (product) => {
            let landingprice = product.landingprice;
            // let offer = (price/100)*data.discountpercentage;
            // let offerprice = (price - offer).toFixed(0);
  ...
  startProductOffers: (date) => {
    ...
    return new Promise(async (resolve, reject) => {
      let data = await db
        .get()
        .collection(collections.PRODUCTOFFER_DETAILS_COLLECTION)
        .find({ prostartDateIso: { $lte: prostartDateIso } })
        .toArray();
  ...
  startCoupenOffers: (date) => {
    ...
    return new Promise(async (resolve, reject) => {
      let data = await db
        .get()
        .collection(collections.COUPEN_DETAILS_COLLECTION)
        .find({ coupenIsoStartDate: { $lte: startIsoDate } })
        .toArray();
  ...
  coupendelete: (date) => {
    ...
    return new Promise(async (resolve, reject) => {
      let data = await db
        .get()
        .collection(collections.COUPEN_DETAILS_COLLECTION)
        .find({ coupenIsoEndDate: { $lte: endIsoDate } })
        .toArray();
      if (data.length > 0) {
        await data.map((onedata) => {
          db.get()
            .collection(collections.COUPEN_DETAILS_COLLECTION)
            .deleteOne({ coupencode: onedata.coupencode });
        });
        resolve();
      } else {
        resolve();
  ...
  checkCoupen: (coupencode, userId) => {
    return new Promise(async (resolve, reject) => {
      ...
      let coupenexist = await db
        .get()
        .collection(collections.COUPEN_DETAILS_COLLECTION)
        .findOne({ coupencode: coupencode, available: true });
        ...
        .aggregate([
...

          {
            $group: {
              ...
              totalandingprice: {
                $sum: { $multiply: ["$quantity", "$products.firstprice"] },
              },
            },
          },
          {
  ...
  filterBrandProducts: (category, brand) => {
    return new Promise(async (resolve, reject) => {
      let data = db
        .get()
        .collection(collections.PRODUCTS_DETAILS_COLLECTION)
        .find({ category: category, brand: brand })
        .toArray();
      resolve(data);
    });
  },
